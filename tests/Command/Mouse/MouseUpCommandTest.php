...
class MouseUpCommandTest extends CommandTestCase
{
    ...
    protected function createCommand(): MouseUpCommand
    {
        return new MouseUpCommand();
    }
