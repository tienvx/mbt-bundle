...
/**
 * @covers \Tienvx\Bundle\MbtBundle\Command\Mouse\DoubleClickAtCommand
 ...
 */
class DoubleClickAtCommandTest extends CommandTestCase
{
    ...
    protected function createCommand(): DoubleClickAtCommand
    {
        return new DoubleClickAtCommand();
    }
    ...
    public function testRun(): void
    {
        ...
        $action->expects($this->once())->method('moveToElement')->with($this->element, 5, 10)->willReturnSelf();
