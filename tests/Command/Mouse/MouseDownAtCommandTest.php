...
/**
 * @covers \Tienvx\Bundle\MbtBundle\Command\Mouse\MouseDownAtCommand
 ...
 */
class MouseDownAtCommandTest extends CommandTestCase
{
    ...
    protected function createCommand(): MouseDownAtCommand
    {
        return new MouseDownAtCommand();
    }
