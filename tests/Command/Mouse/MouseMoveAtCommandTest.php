...
/**
 * @covers \Tienvx\Bundle\MbtBundle\Command\Mouse\MouseMoveAtCommand
 ...
 */
class MouseMoveAtCommandTest extends CommandTestCase
{
    ...
    protected function createCommand(): MouseMoveAtCommand
    {
        return new MouseMoveAtCommand();
    }
